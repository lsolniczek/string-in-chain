...
// StringInChain
#define COCOAPODS_POD_AVAILABLE_StringInChain
#define COCOAPODS_VERSION_MAJOR_StringInChain 0
#define COCOAPODS_VERSION_MINOR_StringInChain 1
#define COCOAPODS_VERSION_PATCH_StringInChain 0
